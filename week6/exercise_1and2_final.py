...
#print("\n\n\n\n\n\n\n", extract_c_alpha(chain_Ax))
#extracted_ca = extract_c_alpha(chain_Ax)

#central_ca_x = extracted_ca[0][4]
#central_ca_y = extracted_ca[1][4]
#central_ca_z = extracted_ca[2][4]

# Solution 

# with x.A we can use x as array (element wise moltiplication) 
# try except
# put a minus in front of the third singular value of the matrix (s)
# assert check what we want to be sure of, if not our program crash